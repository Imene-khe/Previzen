<a xlink:href="departements.php?region=guadeloupe" data-code_insee="01">
  <g>
...
<a xlink:href="departements.php?region=martinique" data-code_insee="02">
  <g>
...
<a xlink:href="departements.php?region=guyane" data-code_insee="03">
  <g>
...
<a xlink:href="departements.php?region=la-réunion" data-code_insee="04">
  <g>
...
<a xlink:href="departements.php?region=mayotte" data-code_insee="06">
  <g>
...
<a xlink:href="departements.php?region=île-de-france" data-code_insee="11">
	<g>	
		<path data-nom="Paris" data-numerodepartement="75" class="region-11 departement departement-75 departement-paris" d="..." >
			<title>Paris</title>
		</path>
		<path data-nom="Seine-et-Marne" data-numerodepartement="77" class="region-11 departement departement-77 departement-seine-et-marne" d="..." >
			<title>Seine-et-Marne</title>
		</path>
		<path data-nom="Yvelines" data-numerodepartement="78" class="region-11 departement departement-78 departement-yvelines" d="..." >
			<title>Yvelines</title>
		</path>
		<path data-nom="Essonne" data-numerodepartement="91" class="region-11 departement departement-91 departement-essonne" d="..." >
			<title>Essonne</title>
		</path>
		<path data-nom="Hauts-de-Seine" data-numerodepartement="92" class="region-11 departement departement-92 departement-hauts-de-seine" d="..." >
			<title>Hauts-de-Seine</title>
		</path>
		<path data-nom="Seine-Saint-Denis" data-numerodepartement="93" class="region-11 departement departement-93 departement-seine-saint-denis" d="..." >
			<title>Seine-Saint-Denis</title>
		</path>
		<path data-nom="Val-de-Marne" data-numerodepartement="94" class="region-11 departement departement-94 departement-val-de-marne" d="..." >
			<title>Val-de-Marne</title>
		</path>
		<path data-nom="Val-d’Oise" data-numerodepartement="95" class="region-11 departement departement-95 departement-val-doise" d="..." >
			<title>Val-d’Oise</title>
		</path>
	</g>
</a>

<a xlink:href="departements.php?region=grand-est" data-code_insee="44">
	<g>	
		<path data-nom="Ardennes" data-numerodepartement="08" class="region-44 departement departement-08 departement-ardennes" d="m469.91,88.14...">
			<title>Ardennes</title>
		</path>
		<path data-nom="Aube" data-numerodepartement="10" class="region-44 departement departement-10 departement-aube" d="m442.2,186.9...">
			<title>Aube</title>
		</path>
		<path data-nom="Marne" data-numerodepartement="51" class="region-44 departement departement-51 departement-marne" d="m440.6,158.9...">
			<title>Marne</title>
		</path>
		<path data-nom="Haute-Marne" data-numerodepartement="52" class="region-44 departement departement-52 departement-haute-marne" d="m493.9,167.9...">
			<title>Haute-Marne</title>
		</path>
		<path data-nom="Meurthe-et-Moselle" data-numerodepartement="54" class="region-44 departement departement-54 departement-meurthe-et-moselle" d="m588.2,170.9...">
			<title>Meurthe-et-Moselle</title>
		</path>
		<path data-nom="Meuse" data-numerodepartement="55" class="region-44 departement departement-55 departement-meuse" d="m516.2,107.97...">
			<title>Meuse</title>
		</path>
		<path data-nom="Moselle" data-numerodepartement="57" class="region-44 departement departement-57 departement-moselle" d="m539.6,124...">
			<title>Moselle</title>
		</path>
		<path data-nom="Bas-Rhin" data-numerodepartement="67" class="region-44 departement departement-67 departement-bas-rhin" d="m631.8,140.7...">
			<title>Bas-Rhin</title>
		</path>
		<path data-nom="Haut-Rhin" data-numerodepartement="68" class="region-44 departement departement-68 departement-haut-rhin" d="m605.9,193...">
			<title>Haut-Rhin</title>
		</path>
		<path data-nom="Vosges" data-numerodepartement="88" class="region-44 departement departement-88 departement-vosges" d="m520.4,183.6...">
			<title>Vosges</title>
		</path>
	</g>
</a>

<a xlink:href="departements.php?region=pays-de-la-loire" data-code_insee="52">
	<g>	
...
<a xlink:href="departements.php?region=bretagne" data-code_insee="53">
	<g>		
...
<a xlink:href="departements.php?region=nouvelle-aquitaine" data-code_insee="75">
	<g>	
		<path data-nom="Charente" data-numerodepartement="16" class="region-75 departement departement-16 departement-charente" d="..." >
			<title>Charente</title>
		</path>
		<path data-nom="Charente-Maritime" data-numerodepartement="17" class="region-75 departement departement-17 departement-charente-maritime" d="..." >
			<title>Charente-Maritime</title>
		</path>
		<path data-nom="Corrèze" data-numerodepartement="19" class="region-75 departement departement-19 departement-correze" d="..." >
			<title>Corrèze</title>
		</path>
		<path data-nom="Creuse" data-numerodepartement="23" class="region-75 departement departement-23 departement-creuse" d="..." >
			<title>Creuse</title>
		</path>
		<path data-nom="Dordogne" data-numerodepartement="24" class="region-75 departement departement-24 departement-dordogne" d="..." >
			<title>Dordogne</title>
		</path>
		<path data-nom="Gironde" data-numerodepartement="33" class="region-75 departement departement-33 departement-gironde" d="..." >
			<title>Gironde</title>
		</path>
		<path data-nom="Landes" data-numerodepartement="40" class="region-75 departement departement-40 departement-landes" d="..." >
			<title>Landes</title>
		</path>
		<path data-nom="Lot-et-Garonne" data-numerodepartement="47" class="region-75 departement departement-47 departement-lot-et-garonne" d="..." >
			<title>Lot-et-Garonne</title>
		</path>
		<path data-nom="Pyrénées-Atlantiques" data-numerodepartement="64" class="region-75 departement departement-64 departement-pyrenees-atlantiques" d="..." >
			<title>Pyrénées-Atlantiques</title>
		</path>
		<path data-nom="Deux-Sèvres" data-numerodepartement="79" class="region-75 departement departement-79 departement-deux-sevres" d="..." >
			<title>Deux-Sèvres</title>
		</path>
		<path data-nom="Vienne" data-numerodepartement="86" class="region-75 departement departement-86 departement-vienne" d="..." >
			<title>Vienne</title>
		</path>
		<path data-nom="Haute-Vienne" data-numerodepartement="87" class="region-75 departement departement-87 departement-haute-vienne" d="..." >
			<title>Haute-Vienne</title>
		</path>
	</g>
</a>

			<a xlink:href="departements.php?region=auvergne-rhône-alpes"> data-code_insee="84">
				<g>	
			...
			<a xlink:href="departements.php?region=provence-alpes-côte-d&#39;azur"> data-code_insee="93">
				<g>	
			...
			<a xlink:href="departements.php?region=corse"> data-code_insee="94">
				<g>	
